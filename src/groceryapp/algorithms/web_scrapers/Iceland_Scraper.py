...
def create_file():
    with open("iceland.csv","w", newline='', encoding="utf-8") as csvfile:
        ...
        writer.writerow(["Title", "Price","tags","ingredients","image","link"])
    return writer
...
def get_Iceland_Items():
    ...
    # urls=[["https://www.iceland.co.uk/drinks?start=400","drinks"]]
    ...
    for links in urls:
        ...
        while True:
            ...
            for i in range(len(results)-1):
                ...
                if item_image==None:
                    item_image=item_doc.find(class_="primary-image")
                ...
                if item_image!=None:
                    ...
                    time.sleep(5)
                    opener.retrieve(item_image['href'],"../../media/images"+item['image'])
                else:
                    item['image']=""
